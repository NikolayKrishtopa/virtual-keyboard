const KEYBOARD = {
  ...
  row4: [
    { size: 'xl', main: 'Shift' },
    { size: 's', main: '\\' },
    { size: 's', en: { shift: 'Z', main: '' }, ru: { shift: 'Я', main: 'я' } },
    { size: 's', en: { shift: 'X', main: '' }, ru: { shift: 'Ч', main: 'ч' } },
    { size: 's', en: { shift: 'C', main: '' }, ru: { shift: 'С', main: 'с' } },
    { size: 's', en: { shift: 'V', main: '' }, ru: { shift: 'М', main: 'м' } },
    { size: 's', en: { shift: 'B', main: '' }, ru: { shift: 'И', main: 'и' } },
    { size: 's', en: { shift: 'N', main: '' }, ru: { shift: 'Т', main: 'т' } },
    { size: 's', en: { shift: 'M', main: '' }, ru: { shift: 'Ь', main: 'ь' } },
