const KEYBOARD = {
  ...
  row3: [
    ...
    { size: 's', en: { shift: 'A', main: 'a' }, ru: { shift: 'Ф', main: 'ф' } },
    { size: 's', en: { shift: 'S', main: 's' }, ru: { shift: 'Ы', main: 'ы' } },
    { size: 's', en: { shift: 'D', main: 'd' }, ru: { shift: 'В', main: 'в' } },
    { size: 's', en: { shift: 'F', main: 'f' }, ru: { shift: 'А', main: 'а' } },
    { size: 's', en: { shift: 'G', main: 'g' }, ru: { shift: 'П', main: 'п' } },
    { size: 's', en: { shift: 'H', main: 'h' }, ru: { shift: 'Р', main: 'р' } },
    { size: 's', en: { shift: 'J', main: 'j' }, ru: { shift: 'О', main: 'о' } },
    { size: 's', en: { shift: 'K', main: 'k' }, ru: { shift: 'Л', main: 'л' } },
    { size: 's', en: { shift: 'L', main: 'l' }, ru: { shift: 'Д', main: 'д' } },
    { size: 's', en: { shift: ':', main: ';' }, ru: { shift: 'Ж', main: 'ж' } },
    { size: 's', en: { shift: '"', main: "'" }, ru: { shift: 'Э', main: 'э' } },
    { size: 'l', main: 'Enter' },
  ],
  row4: [
    { size: 'xl', main: 'Shift' },
